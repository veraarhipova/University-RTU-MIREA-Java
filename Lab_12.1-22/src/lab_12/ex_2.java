...
public class ex_2 {
    ...
    public ex_2(String fp, String sp) {
    ...
    public static void main(String[] args) {
        System.out.println(new ex_2("13579", "24680").play());
        System.out.println(new ex_2("12345", "67890").play());
        System.out.println(new ex_2("13029", "42685").play());
    }
