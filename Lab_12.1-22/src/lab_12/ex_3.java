...
public class ex_3 {
    ...
    public ex_3(String fp, String sp) {
    ...
    public static void main(String[] args) {
        System.out.println(new ex_3("13579", "24680").play());
        System.out.println(new ex_3("12345", "67890").play());
        System.out.println(new ex_3("13029", "42685").play());
    }
