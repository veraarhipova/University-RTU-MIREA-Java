...
public class ex_1 {
    ...
    public ex_1(String fp, String sp) {
        this.fp = new Stack<>();
        this.sp = new Stack<>();
        for(int i = 4; i >= 0; i --){
    ...
    public static void main(String[] args) {
        System.out.println(new ex_1("13579", "24680").play());
        System.out.println(new ex_1("12345", "67890").play());
        System.out.println(new ex_1("13029", "42685").play());
    }
